...
def get_filters():
    ...
    month_name = input("would you like to filter by month or day? input a month name or type 'all' if you do not want month filter .\n").lower()
    while month_name.lower() not in Months:
        print("sorry, wrong choice")
        month_name = input("which month do you want ?input a correct month name or type 'all' if you do not want month filter.\n").lower()
    ...
    day_name = input("which day you want to filter? input a day or type 'all' if you do not want filter day.\n").lower()
